...
* Borrowed binding ergonomics are simplified to emphasize `BorrowedScopeEntry::{dynamic, opaque}` plus context helpers on `BorrowCallContext`, while keeping call-side APIs unchanged.
